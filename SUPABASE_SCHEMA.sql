...
CREATE TABLE IF NOT EXISTS users (
  ...
  avatar_url TEXT,
  phone_number TEXT,
  document_number TEXT, -- CPF/RG
  user_type TEXT CHECK (user_type IN ('user', 'partner')), -- user comum ou parceiro (estabelecimento)
...
-- Parceiros que oferecem serviços
-- ============================================================================
CREATE TABLE IF NOT EXISTS establishments (
  ...
  name TEXT NOT NULL,
  description TEXT,
  category TEXT NOT NULL, -- 'hotel', 'bar', 'restaurant', 'delivery', 'salon', 'mechanic', 'bakery', 'nightclub', 'event_venue'
  logo_url TEXT,
  ...
  offers_services BOOLEAN DEFAULT FALSE, -- agendamento de serviços (salão, mecânica, etc)
...
-- Habilitar full-text search em estabelecimentos
ALTER TABLE establishments ADD COLUMN search_vector tsvector;
UPDATE establishments SET search_vector = to_tsvector('portuguese', COALESCE(name, '') || ' ' || COALESCE(description, '') || ' ' || COALESCE(category, ''));
CREATE INDEX idx_establishments_search ON establishments USING gin(search_vector);

-- ============================================================================
-- 3. TABELA DE SERVIÇOS (Services) - oferecidos por estabelecimentos
-- ============================================================================
CREATE TABLE IF NOT EXISTS services (
  ...
  category TEXT, -- 'haircut', 'massage', 'mechanical', 'decoration', etc
...
-- ============================================================================
-- 4. TABELA DE QUARTOS (Rooms) - para hotéis
-- ============================================================================
CREATE TABLE IF NOT EXISTS rooms (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  establishment_id UUID NOT NULL REFERENCES establishments(id) ON DELETE CASCADE,
  room_number TEXT NOT NULL,
  room_type TEXT NOT NULL, -- 'single', 'double', 'suite', 'presidential'
  capacity INTEGER DEFAULT 1,
  price_per_night DECIMAL(10, 2),
  amenities TEXT[], -- array de amenities: 'wifi', 'tv', 'minibar', etc
  total_rooms INTEGER DEFAULT 1,
  available_rooms INTEGER DEFAULT 1,
  description TEXT,
  room_images TEXT[], -- array de URLs de imagens
...
CREATE TABLE IF NOT EXISTS reservations (
  ...
  reservation_type TEXT NOT NULL CHECK (reservation_type IN ('room', 'table', 'service', 'event')), -- tipo de reserva
...
-- ============================================================================
-- 7. TABELA DE MENUS/ITENS (Menu Items) - para restaurantes e delivery
-- ============================================================================
...
-- ============================================================================
-- 8. TABELA DE PEDIDOS (Orders) - delivery/takeaway
-- ============================================================================
CREATE TABLE IF NOT EXISTS orders (
  ...
  order_type TEXT NOT NULL CHECK (order_type IN ('delivery', 'takeaway')), -- tipo de entrega
  
  -- Itens do pedido (relacionamento N:N gerenciado por order_items)
...
CREATE TABLE IF NOT EXISTS order_items (
  ...
  item_name TEXT NOT NULL, -- salvar nome do item no momento do pedido
...
-- ============================================================================
-- 10. TABELA DE POSTS (Posts) - feed social
-- ============================================================================
CREATE TABLE IF NOT EXISTS posts (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  user_id UUID NOT NULL REFERENCES users(id) ON DELETE CASCADE,
  establishment_id UUID REFERENCES establishments(id) ON DELETE SET NULL, -- post pode ser de um parceiro sobre seu estabelecimento
...
-- Full-text search para posts
ALTER TABLE posts ADD COLUMN search_vector tsvector;
UPDATE posts SET search_vector = to_tsvector('portuguese', COALESCE(content, ''));
...
CREATE TABLE IF NOT EXISTS comments (
  ...
  parent_comment_id UUID REFERENCES comments(id) ON DELETE CASCADE, -- para replies
...
CREATE TABLE IF NOT EXISTS reviews (
  ...
  category TEXT, -- 'service', 'food', 'cleanliness', 'price', 'overall'
  ...
  UNIQUE(user_id, establishment_id) -- um usuário pode avaliar um estabelecimento apenas uma vez
);
...
CREATE TABLE IF NOT EXISTS notifications (
  ...
  related_id UUID, -- ID do post/pedido/reserva relacionado
  related_type TEXT, -- tipo do recurso relacionado
...
CREATE TABLE IF NOT EXISTS payments (
  ...
  -- Relacionamentos (um pagamento pode estar relacionado a)
...
-- ===== USERS POLICIES =====
-- Usuários podem ler perfis públicos e o seu próprio
CREATE POLICY "Users can read their own data and public profiles"
  ON users FOR SELECT
  USING (
    auth.uid() = id OR
    true -- permitir leitura de todos (perfis públicos)
  );
...
-- Atualizar likes_count em posts quando um like é adicionado/removido
...
-- Atualizar comments_count em posts quando um comentário é adicionado
...
-- Atualizar rating de estabelecimento quando novo review é adicionado
...
-- Atualizar updated_at em estabelecimentos
...
-- Função para buscar estabelecimentos próximos (por geolocalização)
...
-- View de posts com informações do usuário
...
-- View de orders com informações completas
